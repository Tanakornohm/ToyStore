...
ArrayList<Toy> toyList = new ArrayList<Toy>();
	...
	@RequestMapping(value= "/car/create-{id}-{name}-{price}-{type}", method=RequestMethod.POST)
	...
	@RequestMapping(value= "/car/update-{id}-{name}-{price}-{type}", method=RequestMethod.POST)
